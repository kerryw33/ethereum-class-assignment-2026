 ...
 */
 // FNBToken is an ERC20 token representing eBucks on-chain.
contract FNBToken is ERC20 {
    /**
     * @notice Deploys the token and mints the entire supply to the deployer at construction (no further minting possible).
